...
using SY_MES.FX.PLC.Base;
using SY_MES.FX.PLC.LS;
...
namespace SY_MES.FX.PLC
{
    public class PLCHelper
    {
        ...
        public Common.PLC_DeviceArray[] CurrentBuffer
        {
            get { return m_sMachPlcBuffer; }
        }
        ...
        public PLCHelper(System.Windows.Forms.Control parentControl, Dictionary<string, string> param, PlcTypeEnum plcType = PlcTypeEnum.NONE)
        {
        ...
        public void Start()
        {
            ...
            string memoryTag = GetVars("@MEMORY_TAG");
            if (string.IsNullOrEmpty(memoryTag) == false)
            {
                m_PLC.MemoryTag = memoryTag;
            }
        ...
        {
            return m_PLC.WriteBit(GetVars("@PLCBASEADDR"), seq, val);
        }
